...
PICS = (environ.get('PICS', 'https://envs.sh/_PH.jpg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://envs.sh/_PH.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "")
SPELL_IMG = environ.get("SPELL_IMG", "https://envs.sh/_PH.jpg")
